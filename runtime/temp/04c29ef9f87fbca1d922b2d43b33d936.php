<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\User\index.html";i:1515130487;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
   ...
   <div class="mws-panel-body no-padding"> 
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
     ...
     <form action="/user/index" method="get">
      	<label><input aria-controls="DataTables_Table_1" type="text" name="keyword"/ value="<?php echo $k; ?>"></label>
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="ss" aria-describedby="DataTables_Table_1_info"> 
      ...
      <?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): if( count($user)==0 ) : echo "" ;else: foreach($user as $key=>$row): ?>
       <tr class="odd" align="center"> 
        ...
        <td class=" "><?php echo $row['pwd']; ?></td>
        <td class=" "> <a href="/userinfo/edit/id/<?php echo $row['id']; ?>" class="btn btn-warning">用户详情</a>&nbsp;&nbsp;&nbsp;<a href="/user/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a>&nbsp;&nbsp;&nbsp;<a href="/user/del/id/<?php echo $row['id']; ?>" class="btn btn-success">删除</a></td> 
       </tr>
     ...
     <div class="dataTables_paginate paging_full_numbers" id="pages">
      <?php echo $user->appends($request)->render(); ?>
     </div>
