<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Goods\add.html";i:1515505499;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
    ...
    <form class="mws-form" action="/goods/insert" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
       ...
       <div class="mws-form-item"> 
          <select name="cate_id" class="large">
            ...
            <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): if( count($cate)==0 ) : echo "" ;else: foreach($cate as $key=>$row): ?>
              <option value="<?php echo $row['id']; ?>" <?php if($row['pid']==0): ?> disabled<?php endif; ?>><?php echo $row['name']; ?></option>
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <select class="large" name="status"> <option value="0">上架</option><option value="1">下架</option><option value="2">售罄</option>   
        </select> 
       </div> 
      </div>
      <div class="mws-form-row"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input type="text" class="large"  name="color"/>
       </div> 
      </div>
       <div class="mws-form-row"> 
       <label class="mws-form-label">容量/大小</label> 
       <div class="mws-form-item"> 
        <input type="text" class="large"  name="capacity"/>
       </div> 
      </div>
      <div class="mws-form-row"> 
       <label class="mws-form-label">套餐</label> 
       <div class="mws-form-item"> 
        <input type="text" class="large"  name="package"/>
       </div> 
      </div>
      <div class="mws-form-row"> 
