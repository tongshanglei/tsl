<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\wamp\www\c\thinkphp5\public/../application/index\view\Orderdetails\reviews.html";i:1516264256;}*/ ?>
<?php echo widget('Index/header'); ?>
<title>我的订单_个人中心_华为商城</title>
<link rel="stylesheet" href="/static/index/order/bs/css/bootstrap.min.css">
<script src="/static/index/order/bs/js/jquery.min.js"></script>
<script src="/static/index/order/bs/js/bootstrap.min.js"></script>
<script src="/static/index/order/bs/js/holder.min.js"></script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title" id="myLargeModalLabel">追加评价</h1>
            </div>
            <div class="modal-body">
                <form action="/iorderdetails/UpdateReviews" method="post">
                    <div class="form-group">
                        <label>评价内容</label>
                        <!-- form-control  使input宽度变为100%-->
                        <textarea class="form-control" rows="3" cols="3" name="content" maxlength="250"></textarea>
                    </div>
            </div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal">&times;</button>
                <h1 class="modal-title" id="myLargeModalLabel">评价</h1>
            </div>
            <div class="modal-body">
                <form action="/iorderdetails/InsertCollect" method="post">
                    <div class="form-group">
                        <label>评价内容</label>
                        <!-- form-control  使input宽度变为100%-->
                        <textarea class="form-control" rows="3" cols="3" name="content" maxlength="250"></textarea>
                    ...
                    <div class="form-group">
                        <label for="">评分</label><br>
                        <input type="hidden" name="star" value="1">
                        <a href="javascript:;"><img src="/static/index/images/star0.png" alt="" class="starms" value="1"></a>
                        <a href="javascript:;"><img src="/static/index/images/star0.png" alt="" class="starms" value="2"></a>
                        <a href="javascript:;"><img src="/static/index/images/star0.png" alt="" class="starms" value="3"></a>
                        <a href="javascript:;"><img src="/static/index/images/star0.png" alt="" class="starms" value="4"></a>
                        <a href="javascript:;"><img src="/static/index/images/star0.png" alt="" class="starms" value="5"></a>
                    </div>
            </div>
            <div class="modal-footer">
                <div class="form-group">
            ...
            <script>
                isClick=false;
                $('.starms').mouseover(function(){
                    isClick=false;
                    $(this).attr('src','/static/index/images/star1.png');
                    $(this).parent('a').prevAll('a').children('img').attr('src','/static/index/images/star1.png');
                    $(this).parent('a').nextAll('a').children('img').attr('src','/static/index/images/star0.png');

                })
                $('.starms').click(function(){
                    isClick=true;
                    $(this).attr('src','/static/index/images/star1.png');
                    $(this).parent('a').prevAll('a').children('img').attr('src','/static/index/images/star1.png');
                    $(this).parent('a').nextAll('a').children('img').attr('src','/static/index/images/star0.png');
                    $('input[name="star"]').val($(this).attr('value'));
                })
                $('.starms').mouseout(function(){
                    if(isClick){
                        return false;
                    }
                    $(this).attr('src','/static/index/images/star0.png');
                    $(this).parent('a').prevAll('a').children('img').attr('src','/static/index/images/star0.png');
                })
                $(document).ready(function(){
                    $('.reviews').click(function(){
                        $('.starms').attr('src','/static/index/images/star0.png');
                        $('input[name="star"]').val(1);
                        $('textarea[name="content"]').val('');
                        $('input[name="oid"]').val($(this).attr('oid'));
                    })
                    $('.editReviews').click(function(){
                        $('textarea[name="content"]').val($(this).parents('td').prev('td').html());
                        $('input[name="oid"]').val($(this).attr('oid'));
    ...
    <div class="g">
        <div class="fr u-4-5"><!-- 20141212-栏目-start -->
            ...
            <div class="myOrder-record" id="myOrders-list-content">
                ...
                <?php if(($info)): foreach($infos as $key=>$row): ?>
                <div class="list-group" id="list-group">
                    <div class="list-group-item">
                        <div class="o-info" style="vertical-align: center;padding-top: 0px">
                            <div class="col-info" ><span class="o-date"><?php echo date("Y-m-d",$row['order_time']); ?></span><span
                                    class="o-no">订单号：<a
                                    href="https://www.vmall.com/member/order-11093009783?isHisData=1"
                                    title="11093009783"><?php echo $row['o_id']; ?></a></span></div>
                            <div class="col-state"><?php echo $arr[$status]; ?></div>
                        </div>
                        <div class="o-pro">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                <tr>
                                    <td class="col-pro-img"><p class="p-img"><a title="<?php echo $row['good_name']; ?>"
                                                                                href="/idetails/index/id/<?php echo $dinfo['id']; ?>"
                                                                                target="_blank"
                                                                                onclick="pushProMsg(837995605,&#39;300130101&#39;)"><img
                                            class="nocomment-1001010038904" alt="<?php echo $row['good_name']; ?>"
                                            src="/goods/publicimg/<?php echo $row['pic']; ?>"></a></p></td>
                                    <td class="col-pro-info"><p class="p-name"><a title="<?php echo $row['good_name']; ?>"
                                                                                  target="_blank"
                                                                                  class="nocomment-1001010038904"
                                                                                  href="https://www.vmall.com/product/673771333.html#837995605"
                                                                                  onclick="pushProMsg(837995605,&#39;300130101&#39;)"><?php echo $row['good_name']; ?></a>
                                    </p></td><td width="50%" class="reviewsContent"><?php foreach($reviews as $v): if($row['o_id']==$v['oid']): ?><?php echo $v['content']; endif; endforeach; ?></td>
                                    <td  class="col-operate">
                                        <p class="p-link">
                                            <?php switch($info[$key]['isReviews']): case "0": ?><a href="javascript:;"  data-toggle="modal" data-target=".bs-example-modal-lg" class="reviews" oid="<?php echo $row['o_id']; ?>">评价</a><?php break; case "1": ?><a href="javascript:;"  data-toggle="modal" data-target="#myModal" oid="<?php echo $row['o_id']; ?>" class="editReviews" oid="<?php echo $row['o_id']; ?>">修改评价</a><?php break; endswitch; ?>
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
