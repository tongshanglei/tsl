<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\notice\index.html";i:1516626830;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                ...
                <tr class="odd" style="text-align: center">
                    ...
                    <td class=" "><?php echo date("Y-m-d H:i:s",$v['addtime']); ?></td>
                    <td class=" "><a href="/notice/edit/id/<?php echo $v['id']; ?>" class="btn btn-info">查看详情或修改</a>&nbsp;<a
                            href="/notice/delete/id/<?php echo $v['id']; ?>" class="btn btn-success">删除</a></td>
                </tr>
                <?php endforeach; ?>
