<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Address\index.html";i:1516102678;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
	...
	<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>会员地址列表</span>
                    	 <form style="margin-top:-30px;float:right;color:#6BFFD3;font-size:15px" action="/address/index" method="get">
							会员ID搜索：<input type="text" name="keyword">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table">
                            ...
                            <tbody>
                            <?php if(is_array($address) || $address instanceof \think\Collection || $address instanceof \think\Paginator): if( count($address)==0 ) : echo "" ;else: foreach($address as $key=>$row): ?>
                                <tr align="center">
                ...
                <?php echo $address->appends($request)->render(); ?>
                 </div>
