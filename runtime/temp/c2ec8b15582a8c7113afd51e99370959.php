<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Admins\rolelist.html";i:1515060955;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <div id="mws-themer">
  ...
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/admins/saverole" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">角色信息</label> 
       <div class="mws-form-item clearfix"> 
        <h4>当前用户:<?php echo $user['name']; ?>的角色信息</h4> 
