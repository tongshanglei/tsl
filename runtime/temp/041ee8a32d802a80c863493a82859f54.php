<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\advert\index.html";i:1515061347;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
        ...
        <form class="mws-form" action="/advert/Update" method="post" enctype="multipart/form-data">
            <div class="mws-form-inline">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <img src="/uploads/<?php echo $info['pic']; ?>" alt="">
                    </div>
                </div>
                <div class="mws-form-row">
                    <div class="mws-form-item">
