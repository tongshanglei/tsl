<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Carousel\index.html";i:1515483101;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
      ...
      <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): if( count($info)==0 ) : echo "" ;else: foreach($info as $key=>$row): ?>
       <tr class="odd" align="center"> 
        ...
        <td class=" "><?php echo $row['status']; ?></td>
         <td class=" "><?php echo $row['pic']; ?></td>
        <td class=" "> <a href="/carousel/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a> <a href="/carousel/del/id/<?php echo $row['id']; ?>" class="btn btn-success">删除</a></td> 
       </tr>
