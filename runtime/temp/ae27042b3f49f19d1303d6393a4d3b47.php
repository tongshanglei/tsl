<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Orderdetails\index.html";i:1516669831;}*/ ?>
...
<script src="/static/index/orderdetails/js/jsapi.js.下载" namespace="ec"></script><!--[if lte IE 6]><script>ol.isIE6=true;</script><![endif]--><!--[if IE 7]><script>ol.isIE7=true;</script><![endif]--><!--[if IE 8]><script>ol.isIE8=true;</script><![endif]-->
...
<div class="g">
    <!--面包屑 -->
<div class="breadcrumb-area fcn"><a href="/index/index">首页</a>&nbsp;&gt;&nbsp;<em id="personCenter"><a href="/ipersonal/index">我的商城</a></em><em id="pathPoint">&nbsp;&gt;&nbsp;</em><span id="pathTitle">我的订单</span></div>   
</div>
<div class="hr-10"></div>
...
<div class="myOrder-cate" id="myOrder-cate">
    <ul>
        <li <?php if(($status == 0)): ?> class="current"<?php endif; ?>><a href="/iorderdetails/index/status/0" onclick="ec.member.orderList.check(this,&#39;all&#39;);"><span>全部有效订单<em></em></span></a></li>
        <li <?php if(($status == 1)): ?> class="current"<?php endif; ?>><a href="/iorderdetails/index/status/1" onclick="ec.member.orderList.check(this,&#39;unpaid&#39;);"><span>待支付<em id="count-seltime-2" class="hide" data-num="0">0</em></span></a></li><!-- 对应后台 用户未支付 -->
        <li <?php if(($status == 2)): ?> class="current"<?php endif; ?>><a href="/iorderdetails/index/status/2" onclick="ec.member.orderList.check(this,&#39;send&#39;);"><span>待收货<em id="count-seltime-3" class="hide" data-num="0">0</em></span></a></li><!-- 对应后台 已发货,用户未收货 -->
        <li <?php if(($status == 4)): ?> class="current"<?php endif; ?>><a href="/iorderdetails/index/status/4" onclick="ec.member.orderList.check(this,&#39;finished&#39;);"><span>已完成</span></a></li>
    </ul>
</div>
...
<div class="myOrder-record" id="myOrders-list-content">
    ...
    <?php if(is_array($infos) || $infos instanceof \think\Collection || $infos instanceof \think\Paginator): if( count($infos)==0 ) : echo "" ;else: foreach($infos as $key=>$row): ?>
    <div class="list-group" id="list-group"><div class="list-group-item"><div class="o-info"><div class="col-info"><span class="o-date"><?php echo date("Y-m-d",$row['order_time']); ?></span><span class="o-no">订单号：<a href="javascript:;" title="11093009783"><?php echo $row['o_id']; ?></a></span></div><div class="col-state"><?php echo $arr[$row['status']]; ?></div></div><div class="o-pro"><table border="0" cellpadding="0" cellspacing="0"><tbody><tr><td class="col-pro-img"><p class="p-img"><a title="<?php echo $row['good_name']; ?>" href="/idetails/index/id/<?php echo $row['gid']; ?>" target="_blank" onclick="pushProMsg(837995605,&#39;300130101&#39;)"><img class="nocomment-1001010038904" alt="<?php echo $row['good_name']; ?>" src="/goods/publicimg/<?php echo $row['pic']; ?>"></a></p></td><td class="col-pro-info"><p class="p-name"><a title="<?php echo $row['good_name']; ?>" target="_blank" class="nocomment-1001010038904" href="/idetails/index/id/<?php echo $row['gid']; ?>" onclick="pushProMsg(837995605,&#39;300130101&#39;)"><?php echo $row['good_name']; ?></a></p></td><td class="col-price"><em>¥</em><span><?php echo $row['price']; ?></span></td><td class="col-quty"><?php echo $row['num']; ?></td><td rowspan="3" class="col-pay"><p><em>¥</em><span><?php echo $row['total']; ?></span></p></td><td rowspan="3" class="col-operate"><?php if(($row['status']==1)): ?><p class="p-link"><a href="/iorder/zfb/id/<?php echo $row['o_id']; ?>" onclick="ec.member.orderList.del(this,11093009783);">前往支付</a></p><?php elseif(($row['status']==2)): ?><p class="p-link"><a href="/Iorderdetails/update/o_id/<?php echo $row['o_id']; ?>" onclick="ec.member.orderList.del(this,11093009783);">确认收货</a></p><?php elseif(($row['status']==4)): ?><p class="p-link"><a href="javascript:;" onclick="ec.member.orderList.del(this,11093009783);">订单已完成</a></p><?php endif; ?><p class="p-link"><a href="javascript:;" onclick="ec.member.orderList.del(this,11093009783);"></a></p></td></tr></tbody></table></div></div></div>
...
<!-- <script src="/static/index/orderdetails/js/orderList.min.js.下载"></script> --><script id="jsapi_loader1" loadtype="insert" type="text/javascript" src="/static/index/orderdetails/js/jquery.form-2.49.js.下载" charset="utf-8"></script><script>(function(){var time = 0,el = document.getElementById('jsapi_loader1');if(!el || (el.readyState && 'complete' != el.readyState)){ if(time<10){ setTimeout(arguments.callee,30); time++; }else{ logger.error('load the script of id jsapi_loader1 fail!');} return; }ol._setLoadStatus("jquery.form","complete");})();</script><script id="jsapi_loader2" loadtype="insert" type="text/javascript" src="/static/index/orderdetails/js/ajax.js.下载" charset="utf-8"></script><script>(function(){var time = 0,el = document.getElementById('jsapi_loader2');if(!el || (el.readyState && 'complete' != el.readyState)){ if(time<10){ setTimeout(arguments.callee,30); time++; }else{ logger.error('load the script of id jsapi_loader2 fail!');} return; }ol._setLoadStatus("ajax","complete");})();</script><script id="jsapi_loader3" loadtype="insert" type="text/javascript" src="/static/index/orderdetails/js/movebar.min.js.下载"></script><script>(function(){var time = 0,el = document.getElementById('jsapi_loader3');if(!el || (el.readyState && 'complete' != el.readyState)){ if(time<10){ setTimeout(arguments.callee,30); time++; }else{ logger.error('load the script of id jsapi_loader3 fail!');} return; }ol._setLoadStatus("jquery.movebar/movebar.min.js","complete");})();</script>
<script src="/static/index/orderdetails/js/add.min.js.下载"></script><script id="jsapi_loader4" loadtype="insert" type="text/javascript" src="/static/index/orderdetails/js/rater-star.js.下载"></script><script>(function(){var time = 0,el = document.getElementById('jsapi_loader4');if(!el || (el.readyState && 'complete' != el.readyState)){ if(time<10){ setTimeout(arguments.callee,30); time++; }else{ logger.error('load the script of id jsapi_loader4 fail!');} return; }ol._setLoadStatus("RaterStar/rater-star.js","complete");})();</script>
<script>
ec.load("ec.pager");
</script><script id="jsapi_loader5" loadtype="insert" type="text/javascript" src="/static/index/orderdetails/js/pager-min.js.下载" charset="gbk"></script><script>(function(){var time = 0,el = document.getElementById('jsapi_loader5');if(!el || (el.readyState && 'complete' != el.readyState)){ if(time<10){ setTimeout(arguments.callee,30); time++; }else{ logger.error('load the script of id jsapi_loader5 fail!');} return; }ol._setLoadStatus("ec.pager/pager-min.js","complete");})();</script></div>
        <div class="fl u-1-5">
