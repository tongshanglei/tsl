<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\nodelist\edit.html";i:1515032427;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/nodelist/update" method="post"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="name" value="<?php echo $info['mname']; ?>"/> 
       </div> 
      </div>
     <div class="mws-form-row"> 
       <label class="mws-form-label">方法名</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="name" value="<?php echo $info['aname']; ?>"/> 
       </div> 
      </div>

      <div class="mws-form-row"> 
       <label class="mws-form-label">角色状态</label> 
       <div class="mws-form-item"> 
