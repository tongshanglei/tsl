<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Admin\index.html";i:1516193175;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <div id="mws-themer">
  ...
  <div id="mws-wrapper"> 
   ...
   <div id="mws-container" class="clearfix"> 
    ...
    <!-- <p>操作系统:<?php echo $info['操作系统']; ?></p>
    <p>运行环境:<?php echo $info['运行环境']; ?></p>
    <p>PHP运行方式:<?php echo $info['PHP运行方式']; ?></p>
    <p>ThinkPHP版本:<?php echo $info['ThinkPHP版本']; ?></p>
    <p>上传附件限制:<?php echo $info['上传附件限制']; ?></p>
    <p>执行时间限制:<?php echo $info['执行时间限制']; ?></p>
    <p>服务器时间:<?php echo $info['服务器时间']; ?></p>
    <p>北京时间:<?php echo $info['北京时间']; ?></p>
    <p>服务器域名/IP:<?php echo $info['服务器域名/IP']; ?></p>
    <p>剩余空间:<?php echo $info['剩余空间']; ?></p> -->
    <center><h2 color="black">系统信息</h2></center>
