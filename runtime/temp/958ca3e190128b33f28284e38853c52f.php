<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Carousel\edit.html";i:1515484664;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
    ...
    <form class="mws-form" action="/carousel/update" method="post" enctype="multipart/form-data"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        ...
        <option value="0" <?php if($info['status'] == 0): ?>selected<?php endif; ?>>0</option><option value="1" <?php if($info['status'] == 1): ?>
        selected<?php endif; ?>>1</option> 
        </select> 
       </div> 
      </div>
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input type="text" class="large"  name="url" value="<?php echo $info['url']; ?>"/>
       </div> 
      </div>
