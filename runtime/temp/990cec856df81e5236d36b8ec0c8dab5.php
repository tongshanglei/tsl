<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Order\index.html";i:1516671013;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
  ...
  <div id="mws-wrapper"> 
   ...
   <div id="mws-container" class="clearfix"> 
	...
	<div class="mws-panel grid_8">
                        ...
                        <table class="mws-table">
                            ...
                            <?php if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): if( count($order)==0 ) : echo "" ;else: foreach($order as $key=>$row): ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo date("Y-m-d H:i:s",$row['order_time']); ?></td>
                                    <td><a href="/order/info/id/<?php echo $row['id']; ?>" class="btn btn-info">查看订单详情</a>
                                    <?php if($row['status']==1): ?> <a href="javascript:void(0)" class="btn btn-danger">未付款</a>
                                        <?php elseif($row['status']==2): ?> <a href="/order/go/id/<?php echo $row['id']; ?>" class="btn btn-info" >点击发货</a>
                                        <?php elseif($row['status']==3): ?> <a href="javascript:void(0)" class="btn btn-success" >待收货</a>
                                        <?php elseif($row['status']==4): ?><a href="javascript:void(0)" class="btn btn-warning" >订单完成</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                ...
                <?php echo $order->appends($request)->render(); ?>
                 </div>
