<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Personal\havequestion.html";i:1516066542;}*/ ?>
<!DOCTYPE html>
<html><head>
...
<body class="userCenter-ucInfo">
	...
	<div class="wp">
		<div class="pannel">
		<form action="/ipersonal/editquestion" method="post" id="ss">

			<input type="hidden" value="<?php echo $id; ?>" name="uid">
	
			<div class="umsg">
				<p class="title" style="font-size:20px;margin-left:80px">修改密保问题</p>
				<p>
				    
					<div id="user"><input type="text" class="form-control" name="lpwd" value="<?php echo $data['question']; ?>"></div>
			 	...
			 	<p>
					...
					<div id="user"><input type="text" class="form-control" name="xpwd" id="xpwd" value="<?php echo $data['answer']; ?>"><div id="m" style="margin-top:10px;margin-left:10px"></div></div>								
				</p>
			    
				
				<p>
				  	<input type="submit"  style="width:120px;height:30px;margin-top:10px;margin-left:90px" value="确认修改">
				</p>
				</form>
			</div>
		</div>
