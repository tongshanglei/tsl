<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Personal\address.html";i:1516673818;}*/ ?>
<!DOCTYPE html>
<html><head>
	...
	<div class="topbar1">
		<div class="tp wp mkcl">
			...
			<div class="left1"> 
			  ...
			  <span class="logo_text1">收货地址管理</span></p>
			</div>
...
<table class="table table-hover" style="font-size:15px" >
  ...
  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): ?>
    <tr>
      ...
      <td><a href="/ipersonal/delete/id/<?php echo $row['id']; ?>">删除</a></td>
    </tr>
