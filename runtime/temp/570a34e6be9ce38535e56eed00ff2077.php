<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Message\add.html";i:1515069563;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/message/insert" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">发送者</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="sendname"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="recid"/> 
       </div> 
      </div> 
      <div class="mws-form-row"> 
