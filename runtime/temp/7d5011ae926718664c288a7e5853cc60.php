<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Orderdetails\reviews.html";i:1516621274;}*/ ?>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="col-pro-img"><p class="p-img"><a title="<?php echo $row['good_name']; ?>"
                                                                                href="/idetails/index/id/<?php echo $row['gid']; ?>"
                                                                                target="_blank"
                                    ...
                                    </p></td><td width="50%" class="reviewsContent"><?php foreach($reviews as $v): if($row['o_id']==$v['oid']): ?><?php echo $v['content']; break; endif; endforeach; ?></td>
                                    <td  class="col-operate">
                                        <p class="p-link">
                                            <?php switch($infos[$key]['isReviews']): case "0": ?><a href="javascript:;"  data-toggle="modal" data-target=".bs-example-modal-lg" class="reviews" oid="<?php echo $row['o_id']; ?>">评价</a><?php break; case "1": ?><a href="javascript:;"  data-toggle="modal" data-target="#myModal" oid="<?php echo $row['o_id']; ?>" class="editReviews" oid="<?php echo $row['o_id']; ?>">修改评价</a><?php break; endswitch; ?>
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
