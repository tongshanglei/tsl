<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Login\question.html";i:1516024438;}*/ ?>
<!DOCTYPE html>
<html><head>
...
<div class="head-background">
    ...
    <div class="g">
    	...
    	<div id="mod-forget-area" class="resetpwd-container">
        	<div class="h">
            	<h3><span>密保问题找回密码</span></h3>
            	<div style="float:right">通过&nbsp;&nbsp;<a href="/ilogin/forget">手机或邮箱账号找回密码></a></div>
            </div>
            <div class="b">
                ...
                <form action="/ilogin/doquestion" method="post" id="ss">
                	<div class="form-edit-area">
                		<div class="head_text"><em>您设置的密保问题：</em></div>
                		<div id="username-input" class="input-area forIdmarBot marginBottom0">
                			<label class="lb_opacity_Class" style="display: none; position: absolute; cursor: text; float: left; z-index: 2; padding-left: 1px; padding-top: 1px;" for="formBean_username"><div style="border: medium none; background: transparent none repeat scroll 0% 0%; cursor: text; margin: 2px; color: rgb(204, 204, 204);" tabindex="-1" class="text vam"></div></label><input autocomplete="off" class="text" id="question" name="question" maxlength="50" tabindex="1" validator="validator11515414860589" style="z-index: 1;" value="<?php echo $data['question']; ?>" type="text" ><div id="zh" style="margin-top:15px;margin-left:30px"></div><span id="msg_username"></span>
                            <input id="fullUserAccount" value="" type="hidden">
                		</div>
                        
                        <div class="head_text"><em>输入您的密保答案：</em></div>
                		<div id="username-input" class="input-area forIdmarBot marginBottom0">
                			<!-- <label class="lb_opacity_Class" style="display: none; position: absolute; cursor: text; float: left; z-index: 2; padding-left: 1px; padding-top: 1px;" for="formBean_username"><div style="border: medium none; background: transparent none repeat scroll 0% 0%; cursor: text; margin: 2px; color: rgb(204, 204, 204);" tabindex="-1" class="text vam">手机号/邮件地址</div></label> --><input autocomplete="off" class="text vam" id="answer" name="answer" maxlength="50" tabindex="1" validator="validator11515414860589" style="z-index: 1;" value="" type="text" placeholder="输入您的密保答案"><span id="msg_pwd"></span>
                            <input id="fullUserAccount" value="" type="hidden">
                		</div>
                		...
                		<div id="username-input" class="input-area forIdmarBot marginBottom0">
                            ...
                            <input id="fullUserAccount" name="u_id" value="<?php echo $data['u_id']; ?>" type="hidden">
                		</div>
                    ...
                    <div class="input-area step-area">
               			<input id="btnSubmit" class="button" value="修改密码" tabindex="3" style="width:210px;" type="submit">
               		</div>
                </div>
            </form>
            </div>
