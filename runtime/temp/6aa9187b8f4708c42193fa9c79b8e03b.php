<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\User\edit.html";i:1516674956;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
    ...
    <form class="mws-form" action="/user/update" method="post"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="pwd" value="<?php echo $info['pwd']; ?>"/> 
       </div> 
      </div> 
     
     </div> 
     <div class="mws-button-row"> 
     <input class="large" type="hidden" name="id" value="<?php echo $info['id']; ?>"/> 
