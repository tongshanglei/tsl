<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Personal\hinfo.html";i:1516065577;}*/ ?>
<!DOCTYPE html>
<html><head>
...
<body class="userCenter-ucInfo">
	...
	<div class="menu wp mkcl">
		<div class="mnr">
			<ul class="nav mkcl">
				...
				<li data-menu="2" class="sel"><a href="">个人信息</a>
				...
				<li data-menu="2" class="sel"><a href="/ipersonal/safe/id/<?php echo $info['uid']; ?>">安全中心</a>
	...
	<div class="wp">
		<div class="pannel">
		<form action="/ipersonal/editinfo" method="post" enctype="multipart/form-data">
			<div class="upic">
				<a href="#" id=""><img style="margin-left:-90px" id="headPic" src="/userinfo/publicimg/<?php echo $info['pic']; ?>"  height="160px" width="160px"></a>
				<div style="margin-top:30px"><input style="width:220px;height:30px" type="file" name="pic"></div>
			</div>
			...
			<div class="umsg">
				...
				<p>
					...
					真实姓名：<div id="user"><input type="text" class="form-control" name="name" value="<?php echo $info['name']; ?>"></div>
			 	...
			 	<p>
					...
					手机号：<div id="user"><input type="text" class="form-control" name="phone" value="<?php echo $info['phone']; ?>"></div>								
				</p>
				...
				<p style="margin-left:80px">
					...
					昵称：<div id="user">
						<div class="" style="margin-top:10px">
						    <label>
						        <input type="radio" name="sex" id="optionsRadios1" value="2" <?php if($info['sex'] == 2): ?>checked<?php endif; ?>>保密
						    </label>
						</div>
						<div class="" style="margin-left:80px;margin-top:-18px">
						    <label>
						        <input type="radio" name="sex" id="optionsRadios1" value="0" <?php if($info['sex'] == 0): ?>checked<?php endif; ?>>女
						    </label>
						</div>
						<div class="" style="margin-left:150px;margin-top:-18px">
						    <label>
						        <input type="radio" name="sex" id="optionsRadios2" value="1" <?php if($info['sex'] == 1): ?>checked<?php endif; ?>>男
						    </label>
						</div>
					</div>
				</p>
				...
				<p style="margin-left:75px">
				  	Email：<div id="user"><input type="text" class="form-control" name="email" value="<?php echo $info['email']; ?>"></div>
				</p>				
				
				<p style="margin-left:75px">
				  	地址：<div id="user"><textarea name="address"  class ="form-control" rows="3" cols="20" ><?php echo $info['address']; ?></textarea></div>
				</p>
				<p>
				  	<input type="submit" style="width:120px;height:30px;margin-top:30px;margin-left:230px" value="修改个人信息">
				</p>
				</form>
			</div>
		</div>
