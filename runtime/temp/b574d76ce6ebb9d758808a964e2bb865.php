<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Rolelist\nodelist.html";i:1515029971;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <div id="mws-themer">
  ...
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/rolelist/savenode" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">角色信息</label> 
       <div class="mws-form-item clearfix"> 
        <h4>当前角色:<?php echo $user['name']; ?>的权限信息</h4> 
        <ul class="mws-form-list inline">
                    <?php if(is_array($node) || $node instanceof \think\Collection || $node instanceof \think\Paginator): if( count($node)==0 ) : echo "" ;else: foreach($node as $key=>$row): ?>
                     <li><input type="checkbox" value="<?php echo $row['id']; ?>" name="rids[]" <?php if(in_array($row['id'],$rids)): ?>checked<?php endif; ?>> <label><?php echo $row['name']; ?></label></li>
     ...
     <div class="mws-button-row">
      <input type="hidden" name="rid" value="<?php echo $user['id']; ?>">
