<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\rolelist\edit.html";i:1515029991;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/rolelist/update" method="post"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <select class="large" name="status"> <option value="1">1</option><option value="2">2</option> <option value="3">3</option>  </select> 
       </div> 
      </div> 
