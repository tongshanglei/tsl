<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Personal\info.html";i:1516027361;}*/ ?>
<!DOCTYPE html>
<html><head>
...
<body class="userCenter-ucInfo">
	...
	<div class="menu wp mkcl">
		<div class="mnr">
			<ul class="nav mkcl">
				...
				<li data-menu="2" class="sel"><a href="/ipersonal/safe/$info['uid']">安全中心</a>
	...
	<div class="wp">
		<div class="pannel">
		<form action="/ipersonal/addinfo" method="post" enctype="multipart/form-data">
			<div class="upic">
				<a href="#" id=""><img style="margin-left:-90px" id="headPic" src="/static/index/userinfo/images/pic.png" height:"160px"="" onerror="" orginsrc="" width="160px"></a>
			...
			<div class="umsg">
				...
				<p>
					...
					真实姓名：<div id="user"><input type="text" class="form-control" name="name"></div>
			 	...
			 	<p>
					...
					手机号：<div id="user"><input type="text" class="form-control" name="phone"></div>								
				</p>
				...
				<p style="margin-left:80px">
					昵称：<div id="user">
						<div class="" style="margin-top:10px">
						    <label>
						        <input type="radio" name="sex" id="optionsRadios1" value="2" checked>保密
						    </label>
						</div>
				...
				<p style="margin-left:75px">
				  	Email：<div id="user"><input type="text" class="form-control" name="email"></div>
				</p>				
				
				<p style="margin-left:75px">
				  	地址：<div id="user"><textarea name="address"  class ="form-control" rows="3" cols="20"></textarea></div>
				</p>
				<p>
				  	<input type="submit" style="width:120px;height:30px;margin-top:30px;margin-left:230px" value="保存个人信息">
				</p>
				</form>
			</div>
		</div>
