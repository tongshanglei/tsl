<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Rolelist\index.html";i:1515030148;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
  ...
  <div class="mws-panel-body no-padding"> 
   ...
   <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
    ...
    <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
     <thead> 
      <tr role="row">
       <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 157px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">角色ID</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 214px;" aria-label="Browser: activate to sort column ascending">角色名</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 138px;" aria-label="Platform(s): activate to sort column ascending">角色状态</th>
     ...
     <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): ?>
      <tr class="odd"> 
       ...
       <td class=""> <a href="/rolelist/node/id/<?php echo $row['id']; ?>" class="btn btn-primary">分配权限</a> <a href="/rolelist/del/id/<?php echo $row['id']; ?>" class="btn btn-success">删除</a> <a href="/rolelist/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a></td> 
      </tr>
