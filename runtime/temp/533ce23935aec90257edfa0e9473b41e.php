<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Order\wait.html";i:1516687953;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
   ...
   <div id="mws-container" class="clearfix"> 
	...
	<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>未发货订单详情</span>
                            ...
                            <?php if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): if( count($order)==0 ) : echo "" ;else: foreach($order as $key=>$row): ?>
                                <tr align="center">
                                   ...
                                   <!--  if(<?php echo $row['id']; ?>==0){
                                        <td><a href="/order/go/id/<?php echo $row['id']; ?>" class="btn btn-success">点击发货</a></td>
                                    }else{
                                        <td><a href="/order/go/id/<?php echo $row['id']; ?>" class="btn btn-success">11</a></td>
                                    } -->
                                   <td><?php if($row['status']==2): ?> <a href="/order/go/id/<?php echo $row['id']; ?>" class="btn btn-success">点击发货</a>
                                        <?php else: ?> <a href="javascript:void(0)" class="btn btn-danger" >已发货</a>
                                        <?php endif; ?>
                                    </td>
