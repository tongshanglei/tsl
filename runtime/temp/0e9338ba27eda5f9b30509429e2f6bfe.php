<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Admins\edit.html";i:1516194187;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/admins/update" method="post"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
       <label class="mws-form-label">管理员状态</label> 
       <div class="mws-form-item"> 
        <select class="large" name="status"> <option value="0">禁用</option><option value="1">正常</option>   </select> 
       </div> 
      </div> 
