<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Carousel\add.html";i:1515484037;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/carousel/insert" method="post" enctype="multipart/form-data"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <select class="large" name="status"> <option value="0">0</option><option value="1">1</option>   
        </select> 
       </div> 
      </div>
      <div class="mws-form-row"> 
