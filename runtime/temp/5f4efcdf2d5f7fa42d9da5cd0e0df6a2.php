<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\notice\add.html";i:1515139766;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel">
    ...
    <div class="mws-panel-body no-padding">
        <form class="mws-form" action="/notice/Insert" method="post">
            <div class="mws-form-inline">
                <div class="mws-form-row">
                    <label class="mws-form-label">标题</label>
                    <div class="mws-form-item">
                        <input class="large" type="text" name="title" style="width: 900px;">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">内容</label>
                    <div class="mws-form-item">
                        <script id="editor" type="text/plain"  name="centent" style="width:900px;height:500px;"></script>
                    </div>
                </div>
            </div>
