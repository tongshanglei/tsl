<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Message\edit.html";i:1516687935;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/message/update" method="post"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">发送者</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="sendname" value="<?php echo $info['sendname']; ?>"/> 
       </div> 
      </div> 
     
      <div class="mws-form-row"> 
       <label class="mws-form-label">接收者id</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="recid" value="<?php echo $info['recid']; ?>"/> 
       </div> 
      </div> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">站内信内容</label> 
       <div class="mws-form-item"> 
        <textarea rows="" cols="" class="large" name="content"><?php echo $info['content']; ?></textarea> 
       </div> 
      </div> 
