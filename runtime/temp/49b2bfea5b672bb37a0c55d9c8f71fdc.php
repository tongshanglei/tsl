<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Message\index.html";i:1515069807;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
  ...
  <div class="mws-panel-body no-padding"> 
   ...
   <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
    ...
    <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
     <thead> 
      <tr role="row">
       <th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 20px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">ID</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 40px;" aria-label="Browser: activate to sort column ascending">发送人</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 80px;" aria-label="Platform(s): activate to sort column ascending">接受者id</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 134px;" aria-label="Engine version: activate to sort column ascending">发送时间</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 400px;" aria-label="Engine version: activate to sort column ascending">发送内容</th>
       <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 134px;" aria-label="CSS grade: activate to sort column ascending">操作</th>
      </tr> 
     </thead> 
     <tbody role="alert" aria-live="polite" aria-relevant="all">
     <?php if(is_array($message) || $message instanceof \think\Collection || $message instanceof \think\Paginator): if( count($message)==0 ) : echo "" ;else: foreach($message as $key=>$row): ?>
      <tr class="odd"> 
       <td class="  sorting_1"><?php echo $row['id']; ?></td> 
       <td class=" "><?php echo $row['sendname']; ?></td> 
       <td class=" "><?php echo $row['recid']; ?></td> 
       <td class=" "><?php echo date("Y-m-d",$row['mtime']); ?></td>
       <td class=" "><?php echo $row['content']; ?></td>
       <td class=""><a href="/message/del/id/<?php echo $row['id']; ?>" class="btn btn-success">删除</a> <a href="/message/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a></td> 
      </tr>
    ...
    <div class="dataTables_paginate paging_full_numbers" id="pages">
     <?php echo $message->appends($request)->render(); ?>
    </div>
   </div> 
  </div> 
 </body>
