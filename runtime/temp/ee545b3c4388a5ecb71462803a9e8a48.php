<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\User\add.html";i:1514900816;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/user/insert" method="post"> 
     <div class="mws-form-inline"> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="pwd"/> 
       </div> 
      </div> 
      <div class="mws-form-row"> 
