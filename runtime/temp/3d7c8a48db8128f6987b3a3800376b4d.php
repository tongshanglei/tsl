<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\User_info\index.html";i:1515129807;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
 ...
 <body>
  <div class="mws-panel grid_8"> 
   <div class="mws-panel-header"> 
    <span><?php echo $tishi; ?></span> 
   </div> 
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/userinfo/<?php echo $action; ?>" method="post" enctype="multipart/form-data"> 
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">用户姓名</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="name" value="<?php echo $m==1?$info['name'] : ''; ?>"/> 
       </div> 
      </div> 
       <div class="mws-form-row">
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="large" type="text" name="phone" value="<?php echo $m==1?$info['phone'] : ''; ?>"/> 
       </div> 
      </div> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">性别</label> 
       <div class="mws-form-item"> 
        <select class="large" name="sex"> <option value="0" <?php if($info['sex'] == 0): ?>selected<?php endif; ?>>女</option><option value="1" <?php if($info['sex'] == 1): ?>
        selected<?php endif; ?>>男</option><option value="2" <?php if($info['sex'] == 2): ?>
        selected<?php endif; ?>>保密</option>   </select> 
       </div> 
      </div> 
     <div class="mws-form-row"> 
       <label class="mws-form-label">邮箱</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="email" value="<?php echo $m==1?$info['email'] : ''; ?>"/> 
       </div> 
      </div> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">地址</label> 
       <div class="mws-form-item"> 
        <input class="large" type="text" name="address" value="<?php echo $m==1?$info['address'] : ''; ?>"/> 
       </div> 
      </div> 
