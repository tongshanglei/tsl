<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\Admins\index.html";i:1515143554;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
  ...
  <div class="mws-panel-body no-padding"> 
   ...
   <!--  <div id="DataTables_Table_1_length" class="dataTables_length">
    ...
    <div class="dataTables_filter" id="DataTables_Table_1_filter">
     <label><input aria-controls="DataTables_Table_1" name="keywords" type="text" value="<?php echo $k; ?>"/></label>
    ...
    <table class="mws-datatable-fn mws-table dataTable" id="ss" aria-describedby="DataTables_Table_1_info"> 
     ...
     <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$row): ?>
      <tr class="odd">
       ...
       <td class=" "><?php echo $status[$row['status']]; ?></td>
       <td class=""> <a href="/admins/rolelist/id/<?php echo $row['id']; ?>" class="btn btn-primary">分配角色</a> <a href="/admins/del/id/<?php echo $row['id']; ?>" class="btn btn-success">删除</a> <a href="/admins/edit/id/<?php echo $row['id']; ?>" class="btn btn-info">修改</a></td> 
      </tr>
    ...
    <div class="dataTables_paginate paging_full_numbers" id="pages">
     <?php echo $list->appends($request)->render(); ?>
    </div>
   </div> 
  </div> 
 </body>
