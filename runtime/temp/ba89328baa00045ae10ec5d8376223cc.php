<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/admin\view\link\index.html";i:1515061482;s:77:"F:\wamp\wamp\www\ss20\zuoye\tp5\application\admin\view\AdminPublic\index.html";i:1516196128;}*/ ?>
<!DOCTYPE html>
        ...
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            ...
            <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                ...
                <tr role="row">
                    ...
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1"
                        colspan="1" style="width: 234.2px;" aria-label="Platform(s): activate to sort column ascending">
                        url名称
                    </th>
                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1"
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <td class=" "><a href="<?php echo $v['url']; ?>" target="_blank" style="color: black;text-decoration:underline"><?php echo $v['url']; ?></a></td>
                    <td class=" "><?php echo $v['name']; ?></td>
                    <td class=" "><?php echo $status[$v['status']]; ?></td>
                    <td class=" "><a href="/link/edit/id/<?php echo $v['id']; ?>" class="btn btn-info">修改</a>&nbsp;<a href="/link/del/id/<?php echo $v['id']; ?>" class="btn btn-success">删除</a></td>
                    </tr>
                    <?php endforeach; ?>
