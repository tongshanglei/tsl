<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"F:\wamp\wamp\www\ss20\zuoye\tp5\public/../application/index\view\Login\number.html";i:1516326223;}*/ ?>
<!DOCTYPE html>
<html><head>
            ...
            <div class="b">
                ...
                <form action="/ilogin/question" method="post" id="ss">
                    ...
                    <div class="input-area step-area">
               			<input id="btnSubmit" class="button" value="提交账号" tabindex="3" style="width:210px;" type="submit">
               		</div>
                </div>
            </form>
            </div>
